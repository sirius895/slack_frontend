...
const SignUp = () => {
    ...
    return (
        <VStack w={"full"} h={"100vh"} bg={"var(--mainColor)"} color={"white"} justify={"center"} align={"center"} px={4}>
            <VStack maxW={"480px"} w={"100%"} h={"600px"} bg={"var(--secondaryColor)"} rounded={"24px"} justify={"center"} align={"center"} gap={4} shadow={"0 0 8px black"} px={8}>
                ...
                <Input borderColor={"var(--fontColor)"} placeholder={"Password"} type={"password"} name="password" value={userInfo.password} onChange={changeUserInfo} />
                <Input borderColor={"var(--fontColor)"} placeholder={"Confirm Password"} type={"password"} name="confirmPassword" value={userInfo.confirmPassword} onChange={changeUserInfo} />
                ...
                <Button w={"full"} _hover={{ transform: "scaleX(1.04)" }} bg={"var(--mainColor)"} shadow={"0 0 4px black"} onClick={handleSignUp}>Sign Up</Button>
            </VStack>
        </VStack>
    )
}
