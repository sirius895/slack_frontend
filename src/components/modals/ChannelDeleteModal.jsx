...
const ChannelDeleteModal = (props) => {
    ...
    return (
        <Modal isOpen={modalStatus === "delete"} isCentered >
            <ModalOverlay />
            <ModalContent w={"full"} h="20%" minH={"200px"} alignItems={"center"} justifyContent={"center"}>
                ...
                <ModalBody display={"flex"} flexDir={"column"} paddingInline={4} w={"full"} gap={4} justifyContent={"center"} alignItems={"center"}>
                    <Text fontFamily={"cursive"} fontSize={24} textAlign={"center"}>Do you really wanna delete this channel?</Text>
                </ModalBody>
